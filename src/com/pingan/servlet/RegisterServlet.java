...
public class RegisterServlet extends HttpServlet {
	...
	// private String registerfilePath;// 存放上传文件的目录
	// private String tempFilePath;// 存放临时文件的目录
	// private String ivectorPath;// 存放特征文件的目录
	...
	public void init(ServletConfig config) throws ServletException {
		...
		// registerfilePath = config.getInitParameter("filePath");
		// tempFilePath = config.getInitParameter("tempFilePath");
		// ivectorPath = config.getInitParameter("Ivector");
		//
		// registerfilePath = getServletContext().getRealPath(registerfilePath);
		// System.out.println("filePath+:" + registerfilePath);
		//
		...
		// }
		//
		// ivectorPath = getServletContext().getRealPath(ivectorPath);

		// File ivectorFile = new File(ivectorPath);
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// service.register(new Customer(randomUUID.toString(), "url"));

		if (isMultipart) {
			// String savePath = this.getServletContext().getRealPath(
			// "register/" + StringUtils.getDate());
			System.out.println("isMutipart=======true");

			// File dir = new File(registerfilePath);
			//
			// if (!dir.exists()) {
			// dir.mkdir();
			// }
